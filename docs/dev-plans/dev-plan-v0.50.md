...
|----------|--------|------|------|------|
| v0.50.1 | 审批工作流 DB 模型 — ReviewTask 表 + 状态机 | P0 | ✅ Done | PRD §7 |
| v0.50.2 | 审批工作流 API — 分配/批准/驳回/重新提交 | P0 | ✅ Done | PRD §7 |
| v0.50.3 | 审批工作流前端 — 审批看板页 | P0 | ✅ Done | PRD §7 |
| v0.50.4 | 审批工作流前端 — 审批操作组件 | P0 | ✅ Done | PRD §7 |
| v0.50.5 | 高危操作二次确认 — 确认码机制 | P1 | ✅ Done | PRD §4.6 |
| v0.50.6 | 术语表文档模板 — doc_type="glossary" | P1 | ✅ Done | PRD §8 |
| v0.50.7 | 维护指南文档模板 — doc_type="maintenance_guide" | P2 | ✅ Done | PRD §8 |
| v0.50.8 | 模型成本看板前端页 | P2 | ✅ Done | PRD §5 UX |
