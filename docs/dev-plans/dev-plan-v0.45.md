...
| v0.45.2 | 后端 PDF / DOCX 导出扩展 | — | 2026-03-31 | 1 | Done |
| v0.45.3 | 前端导出格式选择器 | — | 2026-03-31 | 1 | Done |
| v0.45.4 | AI 摘要 DB 迁移 | — | 2026-03-31 | 1 | Done |
| v0.45.5 | AI 摘要后端 API + orchestrator 任务 | — | 2026-03-31 | 1 | Done |
| v0.45.6 | 前端文档详情页摘要 + 标签展示 | — | 2026-03-31 | 1 | Done |
| v0.45.7 | 前端文档详情页跨文档关联面板 | — | 2026-03-31 | 1 | Done |
| v0.45.8 | 前端图谱页关系编辑操作 | — | 2026-03-31 | 1 | Done |
| v0.45.9 | 前端文档列表虚拟滚动 | — | — | 0 | Planned |
| v0.45.10 | 后端审计写入集成 | — | 2026-03-31 | 1 | Done |
| v0.45.11 | 前端审计日志页 | — | 2026-03-31 | 1 | Done |
| v0.45.12 | 前端全局设置页 | — | 2026-03-31 | 1 | Done |
| v0.45.13 | AI 反思循环 — 后端自检 + 置信度 | — | 2026-03-31 | 1 | Done |
| v0.45.14 | 前端摘要/标签置信度展示 | — | 2026-03-31 | 1 | Done |
